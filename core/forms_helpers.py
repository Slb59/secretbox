...
def action_buttons(
    ...
    back_classes = (
        "inline-block mt-4 focus:outline-none text-white bg-gray-500 hover:bg-gray-800; "
        "focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 "
        "dark:focus:ring-gray-900")
    submit_classe = "bg-rose-500 hover:bg-rose-800; focus:outline-none focus:ring-4 focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:focus:ring-rose-900"
